...
export default function AssignRolepopUpComponent(props) {
  const {role,employees} = props;
  return (
    ...
    <Grid item xs={12} sx={{margin:1,backgroundColor:"#E1E5F8"}}>
            <Item sx={{display:'flex',flexDirection:'row',justifyContent:'space-between',backgroundColor:'#FFFFFF',color:"#4F62B0"}}>
                ...
                <img src={frame} width="17.17px" height="17.17px" alt="SVG" style={{  paddingLeft:"10px",paddingRight:"10px",justifyContent:"center",}} />
                ...
                <Box sx={{width:"50%",textAlign:"center", display:"flex",flexDirection:"row"}} >
                    ...
                    <Typography>{employees}</Typography></Box>
            </Item>
    </Grid>
    </Box> 
  )
